            ...
            <div class="container">
                ...
                <div class="mil-portfolio-grid mil-mb-30">
                    ...
                    <div class="mil-grid-item fil-link">
                        ...
                        <a href="{{ url('project') }}" class="mil-portfolio-item mil-square-item mil-mb-60">
                            <div class="mil-cover">
                                <img src="{{ asset('assets/website') }}/img/portfolio/1.jpg" alt="cover">
                    ...
                    <div class="mil-grid-item fil-gallery">
                        ...
                        <a href="#gallery-1" class="mil-portfolio-item mil-long-item mil-mb-60 mfp-gallery">
                            <div class="mil-cover">
                                <img src="{{ asset('assets/website') }}/img/portfolio/2.jpg" alt="cover">
                                <div class="mil-hover-link">
                    ...
                    <div class="mil-grid-item fil-image">
                        ...
                        <a href="img/portfolio/3.jpg" class="mil-portfolio-item mil-square-item mil-mb-60 mfp-image">
                            <div class="mil-cover">
                                <img src="{{ asset('assets/website') }}/img/portfolio/3.jpg" alt="cover">
                                <div class="mil-hover-link">
                    ...
                    <div class="mil-grid-item fil-link">
                        ...
                        <a href="{{ url('project') }}" class="mil-portfolio-item mil-long-item mil-mb-60">
                            <div class="mil-cover">
                                <img src="{{ asset('assets/website') }}/img/portfolio/4.jpg" alt="cover">
                                <div class="mil-hover-link">
                                    <i class="fas fa-link"></i>
                                </div>
                            </div>
                    ...
                    <div class="mil-grid-item fil-gallery">
                        ...
                        <a href="#gallery-2" class="mil-portfolio-item mil-long-item mil-mb-60 mfp-gallery">
                            <div class="mil-cover">
                                <img src="{{ asset('assets/website') }}/img/portfolio/5.jpg" alt="cover">
                                <div class="mil-hover-link">
                                    <i class="fas fa-plus"></i>
                                </div>
                            </div>
                    ...
                    <div class="mil-grid-item fil-link">
                        ...
                        <a href="{{ url('project') }}" class="mil-portfolio-item mil-square-item mil-mb-60">
                            <div class="mil-cover">
                                <img src="{{ asset('assets/website') }}/img//portfolio/6.jpg" alt="cover">
                                <div class="mil-hover-link">
                                    <i class="fas fa-link"></i>
                                </div>
                            </div>
