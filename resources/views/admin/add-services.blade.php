          ...
          <div class="pd-20 card-box mb-30">
             <div class="clearfix">
                ...
                <div class="pull-right">
                   <a href="{{ route('admin.services.view') }}" class="btn btn-primary btn-sm" ><i class="fa fa-list"></i> View Services</a>
                </div>
             </div>
             <form action="{{ isset($data) ? route('admin.services.save', $data->id) : route('admin.services.save') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label" for="price">Price</label>
                    <div class="col-sm-12 col-md-10">
                       <input class="form-control" type="text" name="price" id="price" placeholder="Enter Price" value="{{ isset($data->price) ? $data->price : '' }}">
                    </div>
                 </div>
