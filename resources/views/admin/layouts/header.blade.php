...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/admin') }}/src/plugins/jvectormap/jquery-jvectormap-2.0.3.css">
	...
	<div class="header">
		...
		<div class="header-right">
			...
			<div class="github-link">
				<a href="https://github.com/dropways/deskapp" target="_blank"><img src="{{ asset('assets/admin') }}/vendors/images/github.svg" alt=""></a>
			</div>
		</div>
	</div>
	...
	<div class="right-sidebar">
		...
		<div class="right-sidebar-body customscroll">
			<div class="right-sidebar-body-content">
				...
				<p>ID: {{ \Session::get('adminData.id') }}</p>
				<p>Email: {{ \Session::get('adminData.email') }}</p>
				<p>Logged in: {{ \Session::get('adminData.is_logged_in') ? 'Yes' : 'No' }}</p>
			</div>
		</div>
	</div>