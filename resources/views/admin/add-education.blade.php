          ...
          <div class="pd-20 card-box mb-30">
             <div class="clearfix">
                ...
                <div class="pull-right">
                   <a href="{{ route('admin.education.view') }}" class="btn btn-primary btn-sm" ><i class="fa fa-list"></i> View Education</a>
                </div>
             </div>
             <form action="{{ isset($data) ? route('admin.education.save', $data->id) : route('admin.education.save') }}" method="POST" enctype="multipart/form-data">
               @csrf
